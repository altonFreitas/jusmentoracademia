...
export const ui = {
  en: {
    ...
    programRegOpen: "Registration open",
    programRegClosed: "Registration closed",
    programRegNow: "Register now",
  ...
  pt: {
    ...
    programRegOpen: "Inscrições abertas",
    programRegClosed: "Inscrições encerradas",
    programRegNow: "Inscrever agora",
