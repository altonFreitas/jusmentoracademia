...
export const ui = {
  en: {
    ...
    regPageTitle: "Course Registration",
    regPageIntro: "Fill in your details below. You can review everything before it's sent.",
    regFullName: "Full Name",
    regDateOfBirth: "Date of Birth",
    regGender: "Gender",
    regGenderSelect: "Select...",
    regGenderMale: "Male",
    regGenderFemale: "Female",
    regGenderOther: "Other",
    regGenderPreferNot: "Prefer not to say",
    regEmail: "Email Address",
    regPhone: "Phone Number",
    regAddress: "Home Address",
    regOccupation: "Current Occupation",
    regContinue: "Continue to Review",
    regReviewTitle: "Review your information",
    regReviewIntro: "Please check everything below is correct before submitting. You can go back and edit any field.",
    regEdit: "Edit",
    regBack: "Back",
    regSubmit: "Submit Registration",
    regSubmitting: "Submitting...",
    regSuccessTitle: "Registration received!",
    regSuccessBody: "Thank you for registering with JusMentor Academia. We'll be in touch soon.",
    regBackHome: "Back to homepage",
    regErrorTitle: "Something went wrong",
    regErrorBody: "We couldn't submit your registration. Please try again, or contact us directly.",
    regClosedTitle: "Registration is currently closed",
    regClosedBody: "We're not accepting new course registrations right now. Please check back later, or contact us directly.",
    regChecking: "Checking registration status…",
    regRequired: "This field is required.",
    regInvalidEmail: "Please enter a valid email address.",
    openMenu: "Open menu",
  ...
  pt: {
    ...
    langLabel: "English",
    courseRegistration: "Registrar ao Curso",
    regPageTitle: "Registo ao Curso",
    regPageIntro: "Preencha os seus dados abaixo. Pode rever tudo antes de enviar.",
    regFullName: "Nome Completo",
    regDateOfBirth: "Data de Nascimento",
    regGender: "Género",
    regGenderSelect: "Selecionar...",
    regGenderMale: "Masculino",
    regGenderFemale: "Feminino",
    regGenderOther: "Outro",
    regGenderPreferNot: "Prefiro não dizer",
    regEmail: "Endereço de Email",
    regPhone: "Número de Telefone",
    regAddress: "Morada",
    regOccupation: "Ocupação Atual",
    regContinue: "Continuar para Revisão",
    regReviewTitle: "Reveja as suas informações",
    regReviewIntro: "Verifique se tudo está correto antes de submeter. Pode voltar atrás e editar qualquer campo.",
    regEdit: "Editar",
    regBack: "Voltar",
    regSubmit: "Submeter Registo",
    regSubmitting: "A submeter...",
    regSuccessTitle: "Registo recebido!",
    regSuccessBody: "Obrigado por se registar na JusMentor Academia. Entraremos em contacto em breve.",
    regBackHome: "Voltar à página inicial",
    regErrorTitle: "Algo correu mal",
    regErrorBody: "Não foi possível submeter o seu registo. Tente novamente, ou contacte-nos diretamente.",
    regClosedTitle: "As inscrições estão atualmente encerradas",
    regClosedBody: "De momento não estamos a aceitar novas inscrições em cursos. Volte mais tarde ou contacte-nos diretamente.",
    regChecking: "A verificar o estado das inscrições…",
    regRequired: "Este campo é obrigatório.",
    regInvalidEmail: "Por favor insira um endereço de email válido.",
    openMenu: "Abrir menu",
